...
const redirect_ja = "https://www.europa-uni.de/de/studium/informieren-orientieren/bewerbung-einschreibung/ba-recht-politik-politik-recht/index.html";
...
function response_text() {
    ...
    if ( percentage > 81 ) {
        ...
        inner_html = `${total_points}/${question_count}. Sehr gut, das passt ziemlich gut zu Deinen Interessen! Wir freuen uns auf Deine <a target="_blank" class="clickable-link" href="${redirect_ja}">Bewerbung!</a>`
    } else if ( percentage > 31 ) {
        inner_html = `${total_points}/${question_count}. Das ist noch ausbaufähig… Aber genau das ist unsere Mission: Dich für die Inhalte unseres <a target="_blank" class="clickable-link" href="${redirect_ja}">Studiums</a> zu begeistern. Bewirb Dich und lass uns Deine Neugierde wecken!`;
    } else {
